 ...
 */
export function usePinch<Config extends UsePinchConfig>(handler: Handler<'pinch'>, config: Config | {} = {}): (...args: any[]) => HookReturnType<Config> {
	const { ...pinch } = config as UsePinchConfig;
